...
#define STRING_VERSION_CONFIG_H "MendelMax_2-0_RAMPS_1-4 on " __DATE__ " " __TIME__ // build date and time
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,1600,462}  // default steps per unit for Ultimaker
